...
set CLASSPATH=%APP_HOME%\lib\application.jar;%APP_HOME%\lib\asg.cliche-110413.jar;%APP_HOME%\lib\guava-20.0.jar;%APP_HOME%\lib\antidote-java-client-0.0.5.jar;%APP_HOME%\lib\protobuf-java-3.0.0.jar

@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" Testcommands %CMD_LINE_ARGS%
